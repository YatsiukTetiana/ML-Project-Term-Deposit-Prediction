...
- Preprocessign original dataset, splitting to train, test, and validation subsets: [process_bank_deposit.py](https://github.com/YatsiukTetiana/ML-Project-Term-Deposit-Prediction/blob/main/process_bank_deposit.py)  
